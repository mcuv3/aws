...
export class UpdateLambdaRequest extends jspb.Message { 
    ...
    getRam(): number;
    setRam(value: number): UpdateLambdaRequest;
    getHandler(): string;
    setHandler(value: string): UpdateLambdaRequest;
    getArn(): string;
    setArn(value: string): UpdateLambdaRequest;
...
export class DeleteLambdaRequest extends jspb.Message { 
    getArn(): string;
    setArn(value: string): DeleteLambdaRequest;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): DeleteLambdaRequest.AsObject;
    static toObject(includeInstance: boolean, msg: DeleteLambdaRequest): DeleteLambdaRequest.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: DeleteLambdaRequest, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): DeleteLambdaRequest;
    static deserializeBinaryFromReader(message: DeleteLambdaRequest, reader: jspb.BinaryReader): DeleteLambdaRequest;
}

export namespace DeleteLambdaRequest {
    export type AsObject = {
        arn: string,
    }
}
