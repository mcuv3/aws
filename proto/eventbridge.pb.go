...
type CreateRuleRequest_EventPattern struct {
	EventPattern *EventPattern `protobuf:"bytes,3,opt,name=event_pattern,json=eventPattern,proto3,oneof" json:"event_pattern,omitempty"`
}
type CreateRuleRequest_ScheduleEvent struct {
	ScheduleEvent *ScheduleEvent `protobuf:"bytes,4,opt,name=schedule_event,json=scheduleEvent,proto3,oneof" json:"schedule_event,omitempty"`
}
...
func init() { proto.RegisterFile("eventbridge.proto", fileDescriptor_60060df97c40c816) }
